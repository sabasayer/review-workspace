...
function file(path: string): RenderedFile {
  return {
    ...
    binary: false,
    hunks: [],
    annotations: [{ id: 'a-file', target: { type: 'file', path }, summary: 'file note' }],
    imageEvidence: [],
    pipelineEvidence: [],
    diagnostics: [],
  }
        ...
        lines: [
          {
            ...
            annotations: [{ id: 'a-line', target: { type: 'line', path: 'src/auth/login.ts', side: 'head', line: 1, expectedText: 'x' }, summary: '' }],
            diagnostics: [],
          },
        ],
      },
